...
import com.timurkhabibulin.domain.Entities.HabitWasDone
...
class HabitsUseCase @Inject constructor(
    ...
    private fun Habit.execute() {
        ...
        val isNewPeriod = when (periodType) {
            com.timurkhabibulin.domain.Entities.PeriodType.DAY -> currentDate.dayOfMonth != dateOfLastExecution.dayOfMonth ||
                    currentDate.month != dateOfLastExecution.month ||
                    currentDate.year != dateOfLastExecution.year

            com.timurkhabibulin.domain.Entities.PeriodType.WEEK -> currentDate.get(ChronoField.ALIGNED_WEEK_OF_YEAR) != dateOfLastExecution.get(
                ChronoField.ALIGNED_WEEK_OF_YEAR
            ) || currentDate.year != dateOfLastExecution.year

            com.timurkhabibulin.domain.Entities.PeriodType.MONTH -> currentDate.month != dateOfLastExecution.month || currentDate.year != dateOfLastExecution.year

            com.timurkhabibulin.domain.Entities.PeriodType.YEAR -> currentDate.year != dateOfLastExecution.year
        }
